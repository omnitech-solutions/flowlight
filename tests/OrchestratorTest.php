...
describe(Orchestrator::class, function () {
    $makeHarness = static function () {
        return new class extends Orchestrator
        {
            ...
            /** @var array<int, callable(Context): void|string> */
            private static array $steps = [];

            /** @var class-string<Action>|null */
            public static ?string $capturedActionClass = null;

            /** @param array<int, (callable(array<string,mixed>): (Context|array<string,mixed>|null))|class-string<Organizer>> $list */
            public static function _setOrganizerSteps(array $list): void
            {
                self::$orgSteps = $list;
            }

            /** @param array<int, callable(Context): void|string> $list */
             ...
             */
            public static function _runOrganizerCallable(callable|string $step, array $input): Context
            {
             ...
             * @param  array<string,mixed>  $input
             */
            public static function _runOrganizerCallableUnsafe(mixed $step, array $input): Context
            {
             ...
             * @param  array<string,mixed>  $input
             */
            public static function _runActionExecute(string $action, array $input): Context
            {
             ...
             * @param  array<string,mixed>  $input
             */
            public static function _runActionExecuteUnsafe(string $action, array $input): Context
            {
                /** @phpstan-ignore-next-line */
                return parent::runActionExecute($action, $input);
            }
             ...
             * @param  null|callable(Context, Context): void  $each
             */
            public static function _call(array $input = [], array $overrides = [], ?callable $each = null): Context
            {
